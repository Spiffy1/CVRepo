...
'''
Description: This program calibrate picture taken from HighResCameraCapture to get the matrix from images
'''
...
# TODO: Why do I care about the disparityToDepthMap? - Because you need to do function test on your code
