...
'''
Description: This program use OpenCV flag to capture image with logitech c270 at higher resolution
How to use: Please, create folder capture/left and capture/right from your project
            folder or configure the path to wherever you want to store your images.
