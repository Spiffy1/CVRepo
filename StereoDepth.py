...
'''
Description:    This program use the matrices you get from HighResCBCalib to rectify 
                and compute the depth information for each frame you get from the stream   
'''
...
calibration = np.load('capture/calib.npz', allow_pickle=False)
...
# left.set(cv2.CAP_PROP_FOURCC, cv2.VideoWriter_fourcc(*"png"))
# right.set(cv2.CAP_PROP_FOURCC, cv2.VideoWriter_fourcc(*"png"))
...
stereoMatcher.setMinDisparity(3)
